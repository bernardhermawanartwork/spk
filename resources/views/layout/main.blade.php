...
<head>
    ...
    <!-- Title -->
    <title>{{ $page_title }} - Responsive Admin Dashboard Template</title>
...
<body>
    <div class="app align-content-stretch d-flex flex-wrap">
        <div class="app-sidebar">
            <div class="logo">
                <a href="index.html" class="logo-icon"><span class="logo-text">{{ $page_title }}</span></a>
    ...
    <script>
        ...
        var html5QrcodeScanner = new Html5QrcodeScanner(
          'qrInput', { fps: 10, qrbox: 250 }
        );
        
        html5QrcodeScanner.render((result) => {
          resultContainer.innerHTML = result;
          // Otomatis isi input dengan hasil pemindaian
          qrInput.value = result;
          // Saat Anda ingin berhenti dari pemindaian
