...
@section('content')
    <div class="content-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                TESTING INPUT QR <input type="text" id="qrInput" placeholder="ini hasil scannya">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <p>Setelah menentukan kriteria dan bobot, langkah selanjutnya adalah mengumpulkan data penerima diakonia. Misalnya, kita memiliki data sebagai berikut:
                                                            <ul class="custom-table">
                                                                <li>Nama<br>{{ $data['nama'] }}</li>
                                                                <li>Kehadiran di Gereja (1-10)</li>
                                                                <li>Status Janda/Duda (0/1)</li>
                                                                <li>Penghasilan (Rupiah)</li>
                                                                <li>Keaktifan dalam Pelayanan (1-10)</li>
                                                            </ul>
                                                            <ul class="custom-table">
