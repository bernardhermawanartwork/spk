<div class="app-menu">
    <ul class="accordion-menu">
        ...
        <li @if ($page_title == 'Dashboard') class="active-page" @endif>
            <a href="/"><i class="material-icons-two-tone">dashboard</i>Dashboard</a>
        </li>
        <li @if ($page_title == 'Jemaat') class="active-page" @endif>
            <a href="/jemaat"><i class="material-icons-two-tone">groups</i>Calon Penerima</a>
        </li>
        <li>
            <a href="/kehadiran"><i class="material-icons-two-tone">event_available</i>Kehadiran</a>
        </li>
        <li>
            <a href="/keaktifan"><i class="material-icons-two-tone">how_to_reg</i>Keaktifan</a>
        </li>
        <li>
            <a href="/diakonia"><i class="material-icons-two-tone">redeem</i>Diakonia</a>
        </li>
        <li>
            <a href="/keputusan"><i class="material-icons-two-tone">checklist</i>Keputusan</a>
        </li>
